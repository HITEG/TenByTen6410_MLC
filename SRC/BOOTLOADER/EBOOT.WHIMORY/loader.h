...
#define PLATFORM_STRING             "TBT6410"
...
typedef enum
{
    ...
    BOOT_DEVICE_USB_SERIAL=1,
    BOOT_DEVICE_USB_RNDIS=2,
    BOOT_DEVICE_USB_DNW=3,
	BOOT_DEVICE_TF_CARD=4,
	NUM_BOOT_DEVICES=5
} BOOT_DEVICE_TYPE;
...
#define EBOOT_BLOCK_RESERVED	(24)
#define EBOOT_SECTOR                BLOCK_TO_SECTOR(EBOOT_BLOCK)

#define IMAGE_BOOT_BLOCKS   (NBOOT_BLOCK_SIZE + TOC_BLOCK_SIZE +TOC_BLOCK_RESERVED + EBOOT_BLOCK_SIZE +2)

// FBImage @ Block IMAGE_BOOT_BLOCKS 20 blocks
#define FBIMAGE_BLOCK				(IMAGE_BOOT_BLOCKS)
#define FBIMAGE_BLOCK_SIZE			(20)
#define FBIMAGE_BLOCK_RESERVED		(0)
#define FBIMAGE_SECTOR				BLOCK_TO_SECTOR(EBOOT_BLOCK)
